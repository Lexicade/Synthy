...
class IRCBridge(commands.Cog):
    ...
    async def irc_on_message(self, message):
        global irc_client
        # if message.channel.id == channel_id and len(message.content) > 0:
        #     # Create webhook
        #     webhook = Webhook.partial(webhook_id, "webhook_str_id", adapter=RequestsWebhookAdapter())
        #
        ...
        #
        #
        #     #https://discordapp.com/api/webhooks/webhook_id/webhook_str_id
        #
